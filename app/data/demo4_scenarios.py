...
DEMO4_SCENARIOS = {
    "scenario_1_crisis": {
        ...
        "description": "Crisis: 15 CNG refueling stations stuck in PESO permits",
        "type": "crisis",
        ...
        "flow_steps": [
            {"from": "UI", "to": "Orchestrator",
             "description": "⚠️ PERMIT CRISIS ALERT: 15 critical Mumbai CNG refueling sites experiencing >90-day PESO permit delays, Q3 revenue targets severely at risk",
             "delay": 800},
            {"from": "Orchestrator", "to": "Permit",
             "description": "Execute comprehensive permit bottleneck analysis across all 15 strategic Mumbai CNG refueling sites for resolution pathway identification",
             "delay": 600},
            {"from": "Permit", "to": "MunicipalPortal",
             "description": "Querying BMC municipal portal system for detailed PESO permit status tracking: sites MUM-001 through MUM-015",
             "delay": 1200},
            {"from": "MunicipalPortal", "to": "Permit",
             "description": "System analysis reveals all sites stuck in 'Pending Review' status due to critical PESO inspector shortage crisis",
             "delay": 800},
            {"from": "Permit", "to": "Orchestrator",
             "description": "🔴 CRITICAL BOTTLENECK IDENTIFIED: PESO operating at 40% capacity causing systematic 6-week processing delays",
             "delay": 500},
            {"from": "Orchestrator", "to": "Financial",
             "description": "Execute comprehensive financial impact calculation for 4-month permit delays across 15 strategic Mumbai CNG refueling sites",
             "delay": 400},
            ...
            {"from": "Orchestrator", "to": "MarketIntelligence",
             "description": "Execute comprehensive Mumbai market scan for competitor CNG refueling station activity during our permit delay period",
             "delay": 400},
            {"from": "MarketIntelligence", "to": "Competitor_DB",
             "description": "Analyzing comprehensive competitor expansion plans and strategic positioning activities across Mumbai CNG refueling market",
             "delay": 900},
            {"from": "Competitor_DB", "to": "MarketIntelligence",
             "description": "🔴 COMPETITIVE THREAT DETECTED: Indian Oil aggressively deploying 12 new CNG dispensing stations, exploiting our permit delays",
             "delay": 700},
            ...
            {"from": "Orchestrator", "to": "LLMGateway",
             "description": "Deploy advanced AI analysis system to generate comprehensive crisis resolution strategy for PESO permit bottleneck",
             "delay": 300},
            {"from": "LLMGateway", "to": "PromptManager",
             "description": "Loading specialized crisis management prompts and PESO permit resolution tactics from strategic template library",
             "delay": 200},
            ...
            {"from": "LLMService", "to": "ReasoningEngine",
             "description": "Analyzing complex PESO permit bottleneck patterns for systematic solutions and strategic intervention opportunities",
             "delay": 600},
            {"from": "ReasoningEngine", "to": "RAGEngine",
             "description": "Retrieve comprehensive historical PESO permit crisis resolution cases from strategic knowledge database for pattern analysis",
             "delay": 400},
            {"from": "RAGEngine", "to": "VectorDB",
             "description": "Search extensive permit crisis database for similar PESO scenarios and proven resolution strategies",
             "delay": 500},
            {"from": "VectorDB", "to": "RAGEngine",
             "description": "Historical success analysis: 3 PESO cases show Commissioner-level engagement achieves 80% faster permit processing",
             "delay": 400},
            ...
            {"from": "SemanticCache", "to": "Orchestrator",
             ...
             "delay": 300},
            {"from": "Orchestrator", "to": "Permit",
             "description": "Execute strategic action plan: Deploy direct PESO Commissioner engagement with escalation timeline and success metrics",
             "delay": 400},
            {"from": "Permit", "to": "Orchestrator",
             "description": "✅ STRATEGY DEPLOYED: PESO Leadership escalation protocol activated with 2-week accelerated processing timeline",
             "delay": 1000},
            {"from": "Orchestrator", "to": "UI",
             "description": "🎯 Crisis resolution plan successfully deployed - PESO Commissioner strategy active with 2-week target commitment",
             "delay": 400}
        ],
        "outcome": {
            "title": "Crisis Successfully Resolved",
            "summary": "AI-powered strategic intervention transforms 90+ day PESO permit crisis into accelerated 2-week resolution",
            "business_results": [
                ...
                "🏆 Competitive Advantage: Blocked Indian Oil's aggressive expansion during our delay",
                "🤝 Stakeholder Relations: PESO Commissioner engagement established for future projects",
                "📈 Market Position: Maintained 15% Mumbai CNG market share leadership",
                "🎯 Q3 Targets: All 15 sites back on track for quarterly expansion goals"
            ],
            "problems_solved": [
                "❌ Permit Bottleneck: PESO inspector shortage causing systematic delays",
                "❌ Revenue Risk: ₹4.8 Cr quarterly revenue target jeopardy",
                "❌ Competitive Threat: Indian Oil exploiting delays with 12 new dispensing stations",
                "❌ Process Inefficiency: Manual permit tracking without escalation protocols",
                "❌ Strategic Gap: Lack of PESO stakeholder engagement framework"
            ],
            "key_innovations": [
                ...
                "🎯 Strategic Escalation: PESO Commissioner-level engagement protocol development",
